...
class outTuple() :
    ...
    def __init__(self,fileName, era, doSyst=False,shift=[], isMC=True, onlyNom=False):
        ...
        self.TriggerSF={'dir' : '../tools/', 'fileMuon' : 'Muon/SingleMuon_Run2018_IsoMu24orIsoMu27.root', 'fileElectron' : 'Electron_RunUL2018_Ele35.root'}
        ...
        self.evaluatorPU=''
        self.fnamePU = "../tools/puWeights_{0:s}.json.gz".format(str(era))
        ...
        if doSyst : 
                    ...
                    if 'nom' not in jes :
                        for var in varss :
                            if 'MET' in i_ and 'T1' in i_: 
                                ...
                                self.list_of_arrays.append(array('d', [ 0 ]))
                                self.list_of_arrays_noES.append(array('d', [ 0 ]))
            ...
            for jes in self.jessyst :
                    if 'nom' in jes :   
                        ...
                        self.list_of_arraysJetsNjets.append( array('d',[0]))
                        self.list_of_arraysJetsNbtagL.append( array('d',[0]))
                        self.list_of_arraysJetsNbtagM.append( array('d',[0]))
                        self.list_of_arraysJetsNbtagT.append( array('d',[0]))
                        self.list_of_arraysJetsFlavour.append( array('d',[-9.99]*12))
                        self.list_of_arraysJetsEta.append( array('d',[-9.99]*12))
                        self.list_of_arraysJetsPt.append( array('d',[-9.99]*12))
                        self.list_of_arraysJetsNbtagDeep.append( array('d',[-9.99]*12))
                    else :   
                        for var in varss :
            ...
            #for i_ in self.allsystMET :  self.list_of_arrays.append(array('d', [ 0 ]))
        ...
        self.nPUtrue              = array('d',[0])
        self.nPV              = array('l',[0])
        self.nPVGood              = array('l',[0])
        self.cat              = array('l',[0])
        self.gen_cat              = array('l',[0])
        self.brWeight           = array('d',[0])
        self.weight           = array('d',[0])
        self.weightPU           = array('d',[0])
        self.weightPUtrue           = array('d',[0])
        self.weightPUtruejson           = array('d',[0])
        self.weightPUtruejson_up           = array('d',[0])
        self.weightPUtruejson_down           = array('d',[0])
        self.LHEweight        = array('d',[0])
        self.Generator_weight = array('d',[0])
        ...
        self.LHEScaleWeights        = array('d',[1]*9)
        self.IDSF_1   = array('d',[0])
        self.ISOSF_1   = array('d',[0])
        self.TrigSF_1   = array('d',[0])
        self.IDSF_2   = array('d',[0])
        self.ISOSF_2   = array('d',[0])
        self.TrigSF_2   = array('d',[0])
        self.IDSF_3   = array('d',[0])
        self.ISOSF_3   = array('d',[0])
        self.TrigSF_3   = array('d',[0])
        self.IDSF_4   = array('d',[0])
        self.ISOSF_4   = array('d',[0])
        self.TrigSF_4   = array('d',[0])
        self.EleID_1 = array('d',[0])
        ...
        self.L1PreFiringWeight_Nom        = array('d',[0])
        self.L1PreFiringWeight_Up        = array('d',[0])
        self.L1PreFiringWeight_Down        = array('d',[0])
        ...
        self.pt_3        = array('d',[0])
        self.pt_3_tr     = array('d',[0])
        self.pt_uncor_1        = array('d',[0])
        self.pt_uncor_2        = array('d',[0])
        self.pt_uncor_3        = array('d',[0])
        self.pt_uncor_4        = array('d',[0])
        self.m_uncor_1        = array('d',[0])
        self.m_uncor_2        = array('d',[0])
        self.m_uncor_3        = array('d',[0])
        self.m_uncor_4        = array('d',[0])

        self.GenPart_statusFlags_3     = array('l',[0])
        self.GenPart_status_3     = array('l',[0])
        self.phi_3       = array('d',[0])
        self.phi_3_tr    = array('d',[0])
        self.eta_3       = array('d',[0])
        self.eta_3_tr    = array('d',[0])
        self.m_3         = array('d',[0])
        self.q_3         = array('d',[0])
        self.d0_3        = array('d',[0])
        self.dZ_3        = array('d',[0])
        self.mt_3        = array('d',[0])
        self.pfmt_3      = array('d',[0])
        #self.puppimt_3   = array('d',[0])
        self.iso_3       = array('d',[0])
        '''
        self.Electron_mvaFall17V2noIso_WP90_1 = array('d',[0])
        self.Electron_mvaFall17V2noIso_WP90_2 = array('d',[0])
        self.Electron_mvaFall17V2noIso_WP90_3 = array('d',[0])
        self.Electron_mvaFall17V2noIso_WP90_4 = array('d',[0])
        '''
        self.gen_match_1 = array('l',[0])
        self.gen_match_2 = array('l',[0])
        self.gen_match_3 = array('l',[0])
        '''self.tightId_3       = array('d',[0])
        self.mediumId_3       = array('d',[0])
        self.mediumPromptId_3       = array('d',[0])
        self.looseId_3       = array('d',[0])
        '''
        self.isGlobal_3       = array('d',[0])
        self.isTracker_3       = array('d',[0])
        self.ip3d_3       = array('d',[0])

        '''self.idDecayModeNewDMs_3 = array('d',[0])
        self.idDeepTau2017v2p1VSe_3 = array('d',[0])
        self.idDeepTau2017v2p1VSjet_3 = array('d',[0])
        self.idDeepTau2017v2p1VSmu_3 = array('d',[0])
        self.idMVAnewDM2017v2_3 = array('d',[0])
        self.rawMVAnewDM2017v2_3 = array('d',[0])
        '''
        ...
        self.pt_4        = array('d',[0])
        self.pt_4_tr     = array('d',[0])
        self.GenPart_statusFlags_4     = array('l',[0])
        self.GenPart_status_4     = array('l',[0])
        self.phi_4       = array('d',[0])
        self.phi_4_tr    = array('d',[0])
        self.eta_4       = array('d',[0])
        self.eta_4_tr    = array('d',[0])
        self.m_4         = array('d',[0])
        self.q_4         = array('d',[0])
        self.d0_4        = array('d',[0])
        self.dZ_4        = array('d',[0])
        self.mt_4        = array('d',[0])
        self.pfmt_4      = array('d',[0])
        #self.puppimt_4   = array('d',[0])
        self.iso_4       = array('d',[0])
        self.gen_match_4 = array('l',[0])
        '''self.tightId_4       = array('d',[0])
        self.mediumId_4       = array('d',[0])
        self.mediumPromptId_4       = array('d',[0])
        self.looseId_4       = array('d',[0])
        '''
        self.isGlobal_4       = array('d',[0])
        self.isTracker_4       = array('d',[0])
        self.ip3d_4       = array('d',[0])


        '''self.idDecayModeNewDMs_4 = array('d',[0])
        self.idDeepTau2017v2p1VSe_4 = array('d',[0])
        self.idDeepTau2017v2p1VSjet_4 = array('d',[0])
        self.idDeepTau2017v2p1VSmu_4 = array('d',[0])
        self.idMVAnewDM2017v2_4 = array('d',[0])
        self.rawMVAnewDM2017v2_4 = array('d',[0])
        '''

        '''#Maybe for 5th particle?Ask Alexis
        self.pt_5        = array('d',[0])
        self.phi_5       = array('d',[0])
        self.eta_5       = array('d',[0])
        self.m_5         = array('d',[0])
        self.q_5         = array('d',[0])
        self.d0_5        = array('d',[0])
        self.dZ_5      = array('d',[0])
        ...
        self.idDecayModeNewDMs_5 = array('d',[0])
        self.idDeepTau2017v2p1VSe_5 = array('d',[0])
        self.idDeepTau2017v2p1VSjet_5 = array('d',[0])
        self.idDeepTau2017v2p1VSmu_5 = array('d',[0])
        self.idMVAnewDM2017v2_5 = array('d',[0])
        self.rawMVAnewDM2017v2_5 = array('d',[0])
        '''
        # di-tau variables
        self.pt_tt  = array('d',[0])
        self.mt_tot = array('d',[0])
        self.m_vis  = array('d',[0])
        self.mDCH1_sv   = array('d',[0])
        self.mDCH2_sv   = array('d',[0])
        self.mtDCH1_sv  = array('d',[0])
        self.mtDCH2_sv  = array('d',[0])
        self.mDCH1_sv4   = array('d',[0])
        self.mDCH2_sv4   = array('d',[0])
        self.mtDCH1_sv4  = array('d',[0])
        self.mtDCH2_sv4  = array('d',[0])
        self.H_DR  = array('d',[0])
        self.AMass   = array('d',[0])


        # di-lepton variables.   1 and 2 refer to plus and minus charge
        # ll_lmass is mass of decay lepton 
        self.H_LT       = array('d',[0])
        self.dRl1H       = array('d',[0])
        self.dRl2H       = array('d',[0])
        self.dRlH       = array('d',[0])
        self.dPhil1H       = array('d',[0])
        self.dPhil2H       = array('d',[0])
        self.dPhilH       = array('d',[0])
        self.mll       = array('d',[0])
        self.mll2       = array('d',[0])
        self.Z_Pt       = array('d',[0])
        self.Z_DR       = array('d',[0])
        ...
        self.pt_1      = array('d',[0])
        self.m_1   = array('d',[0])
        self.m_1_tr   = array('d',[0])
        self.pt_1_tr   = array('d',[0])
        self.GenPart_statusFlags_1   = array('l',[0])
        self.GenPart_status_1     = array('l',[0])
        self.phi_1     = array('d',[0])
        self.phi_1_tr  = array('d',[0])
        self.eta_1     = array('d',[0])
        self.eta_1_tr  = array('d',[0])
        self.pt_2      = array('d',[0])
        self.GenPart_statusFlags_2   = array('l',[0])
        self.GenPart_status_2     = array('l',[0])
        self.m_2   = array('d',[0])
        self.m_2_tr   = array('d',[0])
        self.pt_2_tr   = array('d',[0])
        self.phi_2     = array('d',[0])
        self.phi_2_tr  = array('d',[0])
        self.eta_2     = array('d',[0])
        self.eta_2_tr  = array('d',[0])
        self.iso_1       = array('d',[0])
        self.q_1       = array('d',[0])
        '''self.Muon_Id_1       = array('d',[0])
        self.Muon_Id_2       = array('d',[0])
        self.Muon_Id_3       = array('d',[0])
        '''
        self.isGlobal_1       = array('d',[0])
        self.isTracker_1       = array('d',[0])
        self.isTracker_2       = array('d',[0])
        self.isGlobal_2       = array('d',[0])
        '''self.tightId_1       = array('d',[0])
        self.mediumId_1       = array('d',[0])
        self.mediumPromptId_1       = array('d',[0])
        self.looseId_1       = array('d',[0])
        '''

        # MET variables
        self.met         = array('d',[0])
        self.metphi      = array('d',[0])
        self.metNoTauES      = array('d',[0])
        self.metphiNoTauES      = array('d',[0])
        self.metNoCor         = array('d',[0])
        self.metphiNoCor      = array('d',[0])
        #self.puppimet    = array('d',[0])
        #self.puppimetphi = array('d',[0])
        self.metcov00    = array('d',[0])
        self.metcov01    = array('d',[0])
        self.metcov10    = array('d',[0])
        self.metcov11    = array('d',[0])


        #systematics

        self.MET_pt_UnclUp = array('d',[0])
        self.MET_phi_UnclUp = array('d',[0])
        self.MET_pt_UnclDown = array('d',[0])
        self.MET_phi_UnclDown = array('d',[0])
        self.met_UnclX = array('d',[0])
        self.met_UnclY = array('d',[0])
        self.MET_T1Smear_pt= array('d',[0])
        self.MET_T1Smear_phi= array('d',[0])
        self.MET_pt_nom= array('d',[0])
        self.MET_pt_nom= array('d',[0])

        # trigger info
        self.isTrig_2   = array('d',[0])
        self.isTrig_1   = array('d',[0])
        self.isDoubleTrig   = array('d',[0])


        # jet variables
        #self.njetsold = array('d',[-1]*8)
        self.njets     = array('d',[0])
        self.nbtagL     = array('d',[0])
        self.nbtagM     = array('d',[0])
        self.nbtagT     = array('d',[0])

        self.HTXS_Higgs_cat     = array('l',[0])
        self.HTXS_Higgs_pt     = array('d',[0])

        '''
        self.jpt_1     = array('d',[0])
        self.jpt_1_tr  = array('d',[0])
        self.jeta_1    = array('d',[0])
        self.jeta_1_tr = array('d',[0])
        self.jphi_1    = array('d',[0])
        self.jphi_1_tr = array('d',[0])
        self.jcsv_1    = array('d',[0])
        self.jcsvfv_1    = array('d',[0])
        self.jpt_2     = array('d',[0])
        self.jpt_2_tr  = array('d',[0])
        self.jeta_2    = array('d',[0])
        self.jeta_2_tr = array('d',[0])
        self.jphi_2    = array('d',[0])
        self.jphi_2_tr = array('d',[0])
        self.jcsv_2    = array('d',[0])
        self.jcsvfv_2    = array('d',[0])
        '''
        self.iso_2       = array('d',[0])
        self.q_2       = array('d',[0])
        '''self.tightId_2       = array('d',[0])
        self.mediumId_2       = array('d',[0])
        self.mediumPromptId_2       = array('d',[0])
        self.looseId_2       = array('d',[0])
        '''
        self.jflavour     = array('d',[-9.99]*12)
        self.jeta     = array('d',[-9.99]*12)
        self.jpt     = array('d',[-9.99]*12)
        self.btagDeep     = array('d',[-9.99]*12)

        self.bpt_1     = array('d',[0]*8)
        self.bpt_1_tr  = array('d',[0]*8)
        self.beta_1    = array('d',[0]*8)
        self.beta_1_tr = array('d',[0]*8)
        self.bphi_1    = array('d',[0]*8)
        self.bphi_1_tr = array('d',[0]*8)
        self.bcsv_1    = array('d',[0]*8)
        self.bcsvfv_1    = array('d',[0]*8)
        self.bpt_2     = array('d',[0]*8)
        self.bpt_2_tr  = array('d',[0]*8)
        self.beta_2    = array('d',[0]*8)
        self.beta_2_tr = array('d',[0]*8)
        self.bphi_2    = array('d',[0]*8)
        self.bphi_2_tr = array('d',[0]*8)
        self.bcsv_2    = array('d',[0]*8)
        self.bcsvfv_2    = array('d',[0]*8)
        ...
        self.t.Branch('nPUtrue',              self.nPUtrue,               'nPUtrue/D' )
        ...
        self.t.Branch('brWeight',              self.brWeight,               'brWeight/D' )
        self.t.Branch('weight',           self.weight,            'weight/D' )
        self.t.Branch('weightPU',           self.weightPU,            'weightPU/D' )
        self.t.Branch('weightPUtrue',           self.weightPUtrue,            'weightPUtrue/D' )
        self.t.Branch('weightPUtruejson',           self.weightPUtruejson,            'weightPUtruejson/D' )
        self.t.Branch('weightPUtruejson_up',           self.weightPUtruejson_up,            'weightPUtruejson_up/D' )
        self.t.Branch('weightPUtruejson_down',           self.weightPUtruejson_down,            'weightPUtruejson_down/D' )
        
        self.t.Branch('LHEweight',        self.LHEweight,         'LHEweight/D' )
        self.t.Branch('LHE_Njets',        self.LHE_Njets,         'LHE_Njets/I' )
        self.t.Branch('LHEScaleWeights',        self.LHEScaleWeights,         'LHEScaleWeights[9]/D' )
        self.t.Branch('Generator_weight', self.Generator_weight,  'Generator_weight/D' )
        ...
        self.t.Branch('IDSF_1',           self.IDSF_1,            'IDSF_1/D' )
        self.t.Branch('ISOSF_1',           self.ISOSF_1,            'ISOSF_1/D' )
        self.t.Branch('TrigSF_1',           self.TrigSF_1,            'TrigSF_1/D' )
        self.t.Branch('IDSF_2',           self.IDSF_2,            'IDSF_2/D' )
        self.t.Branch('ISOSF_2',           self.ISOSF_2,            'ISOSF_2/D' )
        self.t.Branch('TrigSF_2',           self.TrigSF_2,            'TrigSF_2/D' )
        self.t.Branch('IDSF_3',           self.IDSF_3,            'IDSF_3/D' )
        self.t.Branch('ISOSF_3',           self.ISOSF_3,            'ISOSF_3/D' )
        self.t.Branch('TrigSF_3',           self.TrigSF_3,            'TrigSF_3/D' )
        self.t.Branch('IDSF_4',           self.IDSF_4,            'IDSF_4/D' )
        self.t.Branch('ISOSF_4',           self.ISOSF_4,            'ISOSF_4/D' )
        self.t.Branch('TrigSF_4',           self.TrigSF_4,            'TrigSF_4/D' )
        self.t.Branch('EleID_1',           self.EleID_1,            'EleID_1/D' )
        ...
        self.t.Branch('pt_uncor_1',        self.pt_uncor_1,        'pt_uncor_1/D')
        self.t.Branch('pt_uncor_2',        self.pt_uncor_2,        'pt_uncor_2/D')
        self.t.Branch('pt_uncor_3',        self.pt_uncor_3,        'pt_uncor_3/D')
        self.t.Branch('pt_uncor_4',        self.pt_uncor_4,        'pt_uncor_4/D')
        self.t.Branch('m_uncor_1',        self.m_uncor_1,        'm_uncor_1/D')
        self.t.Branch('m_uncor_2',        self.m_uncor_2,        'm_uncor_2/D')
        self.t.Branch('m_uncor_3',        self.m_uncor_3,        'm_uncor_3/D')
        self.t.Branch('m_uncor_4',        self.m_uncor_4,        'm_uncor_4/D')
        self.t.Branch('pt_3',        self.pt_3,        'pt_3/D')
        self.t.Branch('pt_3_tr',     self.pt_3_tr,     'pt_3_tr/D')
        self.t.Branch('phi_3',       self.phi_3,       'phi_3/D')
        self.t.Branch('phi_3_tr',    self.phi_3_tr,    'phi_3_tr/D')
        self.t.Branch('eta_3',       self.eta_3,       'eta_3/D')
        self.t.Branch('eta_3_tr',    self.eta_3_tr,    'eta_3_tr/D')
        self.t.Branch('m_3',         self.m_3,         'm_3/D')
        self.t.Branch('q_3',         self.q_3,         'q_3/D')
        self.t.Branch('d0_3',        self.d0_3,        'd0_3/D')
        self.t.Branch('dZ_3',        self.dZ_3,        'dZ_3/D')
        self.t.Branch('mt_3',        self.mt_3,        'mt_3/D')
        self.t.Branch('pfmt_3',      self.pfmt_3,      'pfmt_3/D')
        #self.t.Branch('puppimt_3',   self.puppimt_3,   'puppimt_3/D')
        self.t.Branch('iso_3',       self.iso_3,       'iso_3/D')
        '''
        self.t.Branch('Electron_mvaFall17V2noIso_WP90_1', self.Electron_mvaFall17V2noIso_WP90_1, 'Electron_mvaFall17V2noIso_WP90_1/D')
        self.t.Branch('Electron_mvaFall17V2noIso_WP90_2', self.Electron_mvaFall17V2noIso_WP90_2, 'Electron_mvaFall17V2noIso_WP90_2/D')
        self.t.Branch('Electron_mvaFall17V2noIso_WP90_3', self.Electron_mvaFall17V2noIso_WP90_3, 'Electron_mvaFall17V2noIso_WP90_3/D')
        self.t.Branch('Electron_mvaFall17V2noIso_WP90_4', self.Electron_mvaFall17V2noIso_WP90_4, 'Electron_mvaFall17V2noIso_WP90_4/D')
        '''
        ...
        '''self.t.Branch('tightId_3', self.tightId_3, 'tightId_3/D')
        self.t.Branch('mediumId_3', self.mediumId_3, 'mediumId_3/D')
        self.t.Branch('mediumPromptId_3', self.mediumPromptId_3, 'mediumPromptId_3/D')
        self.t.Branch('looseId_3', self.looseId_3, 'looseId_3/D')
        '''
        self.t.Branch('isGlobal_3', self.isGlobal_3, 'isGlobal_3/D')
        self.t.Branch('isTracker_3', self.isTracker_3, 'isTracker_3/D')
        self.t.Branch('ip3d_3', self.ip3d_3, 'ip3d_3/D')


        '''self.t.Branch('idDecayModeNewDMs_3', self.idDecayModeNewDMs_3, 'idDecayModeNewDMs_3/D')
        self.t.Branch('idDeepTau2017v2p1VSe_3', self.idDeepTau2017v2p1VSe_3, 'idDeepTau2017v2p1VSe_3/D')
        self.t.Branch('idDeepTau2017v2p1VSjet_3', self.idDeepTau2017v2p1VSjet_3, 'idDeepTau2017v2p1VSjet_3/D')
        self.t.Branch('idDeepTau2017v2p1VSmu_3', self.idDeepTau2017v2p1VSmu_3, 'idDeepTau2017v2p1VSmu_3/D')
        self.t.Branch('idMVAnewDM2017v2_3', self.idMVAnewDM2017v2_3, 'idMVAnewDM2017v2_3/D')
        self.t.Branch('rawMVAnewDM2017v2_3', self.rawMVAnewDM2017v2_3, 'rawMVAnewDM2017v2_3/D')
        '''
        self.t.Branch('decayMode_3',   self.decayMode_3,   'decayMode_3/I')
        self.t.Branch('decayMode_4',   self.decayMode_4,   'decayMode_4/I')

        self.t.Branch('pt_4',        self.pt_4,        'pt_4/D')
        self.t.Branch('pt_4_tr',     self.pt_4_tr,        'pt_4_tr/D')
        self.t.Branch('phi_4',       self.phi_4,       'phi_4/D')
        self.t.Branch('phi_4_tr',    self.phi_4_tr,    'phi_4_tr/D')
        self.t.Branch('eta_4',       self.eta_4,       'eta_4/D')
        self.t.Branch('eta_4_tr',    self.eta_4_tr,    'eta_4_tr/D')
        self.t.Branch('m_4',         self.m_4,         'm_4/D')
        self.t.Branch('q_4',         self.q_4,         'q_4/D')
        self.t.Branch('d0_4',        self.d0_4,        'd0_4/D')
        self.t.Branch('dZ_4',        self.dZ_4,        'dZ_4/D')
        self.t.Branch('mt_4',        self.mt_4,        'mt_4/D')
        self.t.Branch('pfmt_4',      self.pfmt_4,      'pfmt_4/D')
        #self.t.Branch('puppimt_4',   self.puppimt_4,   'puppimt_4/D')
        self.t.Branch('iso_4',       self.iso_4,       'iso_4/D')
        self.t.Branch('gen_match_4', self.gen_match_4, 'gen_match_4/l')
        '''self.t.Branch('tightId_4', self.tightId_4, 'tightId_4/D')
        self.t.Branch('mediumId_4', self.mediumId_4, 'mediumId_4/D')
        self.t.Branch('mediumPromptId_4', self.mediumPromptId_4, 'mediumPromptId_4/D')
        self.t.Branch('looseId_4', self.looseId_4, 'looseId_4/D')
        '''
        self.t.Branch('isGlobal_4', self.isGlobal_4, 'isGlobal_4/D')
        self.t.Branch('isTracker_4', self.isTracker_4, 'isTracker_4/D')
        self.t.Branch('ip3d_4', self.ip3d_4, 'ip3d_4/D')


        '''self.t.Branch('idDecayModeNewDMs_4', self.idDecayModeNewDMs_4, 'idDecayModeNewDMs_4/D')
        self.t.Branch('idDeepTau2017v2p1VSe_4', self.idDeepTau2017v2p1VSe_4, 'idDeepTau2017v2p1VSe_4/D')
        self.t.Branch('idDeepTau2017v2p1VSjet_4', self.idDeepTau2017v2p1VSjet_4, 'idDeepTau2017v2p1VSjet_4/D')
        self.t.Branch('idDeepTau2017v2p1VSmu_4', self.idDeepTau2017v2p1VSmu_4, 'idDeepTau2017v2p1VSmu_4/D')
        self.t.Branch('idMVAnewDM2017v2_4', self.idMVAnewDM2017v2_4, 'idMVAnewDM2017v2_4/D')
        self.t.Branch('rawMVAnewDM2017v2_4', self.rawMVAnewDM2017v2_4, 'rawMVAnewDM2017v2_4/D')
        '''
        self.t.Branch('decayMode_1',   self.decayMode_1,   'decayMode_1/I')
        self.t.Branch('decayMode_2',   self.decayMode_2,   'decayMode_2/I')

        '''
        self.t.Branch('pt_5',        self.pt_5,        'pt_5/D')
        self.t.Branch('phi_5',       self.phi_5,       'phi_5/D')
        self.t.Branch('eta_5',       self.eta_5,       'eta_5/D')
        self.t.Branch('m_5',         self.m_5,         'm_5/D')
        self.t.Branch('q_5',         self.q_5,         'q_5/D')
        self.t.Branch('dZ_5',        self.dZ_5,        'dZ_5/D')
        self.t.Branch('d0_5',        self.d0_5,        'd0_5/D')
        self.t.Branch('gen_match_5', self.gen_match_5, 'gen_match_5/l')
        self.t.Branch('decayMode_5',   self.decayMode_5,   'decayMode_5/I')


        self.t.Branch('idDecayModeNewDMs_5', self.idDecayModeNewDMs_5, 'idDecayModeNewDMs_5/D')
        self.t.Branch('idDeepTau2017v2p1VSe_5', self.idDeepTau2017v2p1VSe_5, 'idDeepTau2017v2p1VSe_5/D')
        self.t.Branch('idDeepTau2017v2p1VSjet_5', self.idDeepTau2017v2p1VSjet_5, 'idDeepTau2017v2p1VSjet_5/D')
        self.t.Branch('idDeepTau2017v2p1VSmu_5', self.idDeepTau2017v2p1VSmu_5, 'idDeepTau2017v2p1VSmu_5/D')
        self.t.Branch('idMVAnewDM2017v2_5', self.idMVAnewDM2017v2_5, 'idMVAnewDM2017v2_5/D')
        self.t.Branch('rawMVAnewDM2017v2_5', self.rawMVAnewDM2017v2_5, 'rawMVAnewDM2017v2_5/D')
        '''



        # di-tau variables
        self.t.Branch('pt_tt', self.pt_tt, 'pt_tt/D')
        self.t.Branch('mt_tot', self.mt_tot, 'mt_tot/D')
        self.t.Branch('m_vis', self.m_vis, 'm_vis/D')
        self.t.Branch('mDCH1_sv', self.mDCH1_sv, 'mDCH1_sv/D')
        self.t.Branch('mtDCH1_sv', self.mtDCH1_sv, 'mtDCH1_sv/D') 
        self.t.Branch('mDCH2_sv', self.mDCH2_sv, 'mDCH2_sv/D')
        self.t.Branch('mtDCH2_sv', self.mtDCH2_sv, 'mtDCH2_sv/D')
        self.t.Branch('mDCH1_sv4', self.mDCH1_sv4, 'mDCH1_sv4/D')
        self.t.Branch('mtDCH1_sv4', self.mtDCH1_sv4, 'mtDCH1_sv4/D')
        self.t.Branch('mDCH2_sv4', self.mDCH2_sv4, 'mDCH2_sv4/D')
        self.t.Branch('mtDCH2_sv4', self.mtDCH2_sv4, 'mtDCH2_sv4/D')
        self.t.Branch('H_DR', self.H_DR, 'H_DR/D')
        self.t.Branch('AMass', self.AMass, 'AMass/D')

        # di-lepton variables. 
        self.t.Branch('H_LT',         self.H_LT,         'H_LT/D')   
        self.t.Branch('dRl1H',         self.dRl1H,         'dRl1H/D')   
        self.t.Branch('dRl2H',         self.dRl2H,         'dRl2H/D')   
        self.t.Branch('dRlH',         self.dRlH,         'dRlH/D')   
        self.t.Branch('dPhil1H',         self.dPhil1H,         'dPhil1H/D')   
        self.t.Branch('dPhil2H',         self.dPhil2H,         'dPhil2H/D')   
        self.t.Branch('dPhilH',         self.dPhilH,         'dPhilH/D')   

        self.t.Branch('mll',         self.mll,         'mll/D')   
        self.t.Branch('mll2',         self.mll2,         'mll2/D')   
        self.t.Branch('Z_Pt',       self.Z_Pt,       'Z_Pt/D')   
        self.t.Branch('Z_DR',       self.Z_DR,       'Z_DR/D')   
        self.t.Branch('Z_SS',       self.Z_SS,       'Z_SS/D')   
        self.t.Branch('pt_1',        self.pt_1,        'pt_1/D')
        self.t.Branch('m_1',     self.m_1,     'm_1/D')
        self.t.Branch('m_1_tr',     self.m_1_tr,     'm_1_tr/D')
        self.t.Branch('pt_1_tr',     self.pt_1_tr,     'pt_1_tr/D')
        self.t.Branch('phi_1',       self.phi_1,       'phi_1/D')  
        self.t.Branch('phi_1_tr',    self.phi_1_tr,    'phi_1_tr/D')
        self.t.Branch('eta_1',       self.eta_1,       'eta_1/D')    
        self.t.Branch('eta_1_tr',    self.eta_1_tr,    'eta_1_tr/D')
        self.t.Branch('pt_2',        self.pt_2,        'pt_2/D')      
        self.t.Branch('m_2',     self.m_2,     'm_2/D')
        self.t.Branch('m_2_tr',     self.m_2_tr,     'm_2_tr/D')
        self.t.Branch('pt_2_tr',     self.pt_2_tr,     'pt_2_tr/D')
        self.t.Branch('phi_2',       self.phi_2,       'phi_2/D')    
        self.t.Branch('phi_2_tr',    self.phi_2_tr,    'phi_2_tr/D')
        self.t.Branch('eta_2',       self.eta_2,       'eta_2/D')      
        self.t.Branch('eta_2_tr',    self.eta_2_tr,    'eta_2_tr/D')
        self.t.Branch('iso_1',       self.iso_1,       'iso_1/D')
        self.t.Branch('iso_2',       self.iso_2,       'iso_2/D')
        self.t.Branch('q_1',       self.q_1,       'q_1/D')
        self.t.Branch('q_2',       self.q_2,       'q_2/D')
        self.t.Branch('L1PreFiringWeight_Nom',        self.L1PreFiringWeight_Nom,        'L1PreFiringWeight_Nom/D')
        self.t.Branch('L1PreFiringWeight_Up',        self.L1PreFiringWeight_Up,        'L1PreFiringWeight_Up/D')
        self.t.Branch('L1PreFiringWeight_Down',        self.L1PreFiringWeight_Down,        'L1PreFiringWeight_Down/D')
        self.t.Branch('d0_1',        self.d0_1,        'd0_1/D')
        self.t.Branch('dZ_1',        self.dZ_1,        'dZ_1/D')
        self.t.Branch('d0_2',        self.d0_2,        'd0_2/D')
        self.t.Branch('dZ_2',        self.dZ_2,        'dZ_2/D')
        '''self.t.Branch('Muon_Id_1',       self.Muon_Id_1,       'Muon_Id_1/D')
        self.t.Branch('Muon_Id_2',       self.Muon_Id_2,       'Muon_Id_2/D')
        '''
        self.t.Branch('isGlobal_1',       self.isGlobal_1,       'isGlobal_1/D')
        self.t.Branch('isGlobal_2',       self.isGlobal_2,       'isGlobal_2/D')
        self.t.Branch('isTracker_1',       self.isTracker_1,       'isTracker_1/D')
        self.t.Branch('isTracker_2',       self.isTracker_2,       'isTracker_2/D')
        '''self.t.Branch('tightId_1', self.tightId_1, 'tightId_1/D')
        self.t.Branch('mediumId_1', self.mediumId_1, 'mediumId_1/D')
        self.t.Branch('mediumPromptId_1', self.mediumPromptId_1, 'mediumPromptId_1/D')
        self.t.Branch('looseId_1', self.looseId_1, 'looseId_1/D')
        self.t.Branch('tightId_2', self.tightId_2, 'tightId_2/D')
        self.t.Branch('mediumId_2', self.mediumId_2, 'mediumId_2/D')
        self.t.Branch('mediumPromptId_2', self.mediumPromptId_2, 'mediumPromptId_2/D')
        self.t.Branch('looseId_2', self.looseId_2, 'looseId_2/D')
        '''
        #systematics
        self.t.Branch('MET_pt_UnclUp', self.MET_pt_UnclUp, 'MET_pt_UnclUp/D')
        self.t.Branch('MET_phi_UnclUp', self.MET_phi_UnclUp, 'MET_phi_UnclUp/D')
        self.t.Branch('MET_pt_UnclDown', self.MET_pt_UnclDown, 'MET_pt_UnclDown/D')
        self.t.Branch('MET_phi_UnclDown', self.MET_phi_UnclDown, 'MET_phi_UnclDown/D')
        self.t.Branch('met_UnclX', self.met_UnclX, 'met_UnclX/D')
        self.t.Branch('met_UnclY', self.met_UnclY, 'met_UnclY/D')
        self.t.Branch('MET_T1Smear_pt', self.MET_T1Smear_pt, 'MET_T1Smear_pt/D')
        self.t.Branch('MET_T1Smear_phi', self.MET_T1Smear_phi, 'MET_T1Smear_phi/D')
        
        # MET variables
        self.t.Branch('met', self.met, 'met/D')
        self.t.Branch('metphi', self.metphi, 'metphi/D')
        self.t.Branch('metNoCor', self.metNoCor, 'metNoCor/D')
        self.t.Branch('metphiNoCor', self.metphiNoCor, 'metphiNoCor/D')
        self.t.Branch('metNoTauES', self.metNoTauES, 'metNoTauES/D')
        self.t.Branch('metphiNoTauES', self.metphiNoTauES, 'metphiNoTauES/D')
        #self.t.Branch('puppimet', self.puppimet, 'puppimet/D')
        #self.t.Branch('puppimetphi', self.puppimetphi, 'puppimetphi/D')
        self.t.Branch('metcov00', self.metcov00, 'metcov00/D')
        self.t.Branch('metcov01', self.metcov01, 'metcov01/D')
        self.t.Branch('metcov10', self.metcov10, 'metcov10/D')
        self.t.Branch('metcov11', self.metcov11, 'metcov11/D')

        # trigger sf
        self.t.Branch('isTrig_2',  self.isTrig_2, 'isTrig_2/D' )
        self.t.Branch('isTrig_1',  self.isTrig_1, 'isTrig_1/D' )
        self.t.Branch('isDoubleTrig',  self.isDoubleTrig, 'isDoubleTrig/D' )


        # jet variables
        #self.t.Branch('njetsold', self.njetsold, 'njetsold[8]/D') 
        #self.t.Branch('nbtagold', self.nbtagold, 'nbtagold[8]/D')
        self.t.Branch('njets', self.njets, 'njets/D')
        self.t.Branch('nbtagL', self.nbtagL, 'nbtagL/D')
        self.t.Branch('nbtagM', self.nbtagM, 'nbtagM/D')
        self.t.Branch('nbtagT', self.nbtagT, 'nbtagT/D')
        self.t.Branch('HTXS_Higgs_cat', self.HTXS_Higgs_cat, 'HTXS_Higgs_cat/l')
        self.t.Branch('HTXS_Higgs_pt', self.HTXS_Higgs_pt, 'HTXS_Higgs_pt/D')


        self.t.Branch('jflavour',     self.jflavour,     'jflavour[12]/D' )
        self.t.Branch('jeta',     self.jeta,     'jeta[12]/D' )
        self.t.Branch('jpt',     self.jpt,     'jpt[12]/D' )
        self.t.Branch('btagDeep', self.btagDeep, 'btagDeep[12]/D')

        '''
        self.t.Branch('jpt_1',     self.jpt_1,     'jpt_1/D' )
        self.t.Branch('jpt_2',     self.jpt_2,     'jpt_2/D' )

        self.t.Branch('jpt_1_tr',  self.jpt_1_tr,  'jpt_1_tr/D' )
        self.t.Branch('jeta_1',    self.jeta_1,    'jeta_1/D' ) 
        self.t.Branch('jeta_1_tr', self.jeta_1_tr, 'jeta_1_tr/D' )
        self.t.Branch('jphi_1',    self.jphi_1,    'jphi_1/D' )
        self.t.Branch('jphi_1_tr', self.jphi_1_tr, 'jphi_1_tr/D' )
        self.t.Branch('jcsv_1',    self.jcsv_1,    'jcsv_1/D' )
        self.t.Branch('jcsvfv_1', self.jcsvfv_1, 'jcsvfv_1/D' )
        self.t.Branch('jpt_2',     self.jpt_2,     'jpt_2/D' )
        self.t.Branch('jpt_2_tr',  self.jpt_2_tr,  'jpt_2_tr/D' )
        self.t.Branch('jeta_2',    self.jeta_2,    'jeta_2/D' ) 
        self.t.Branch('jeta_2_tr', self.jeta_2_tr, 'jeta_2_tr/D' )
        self.t.Branch('jphi_2',    self.jphi_2,    'jphi_2/D' )
        self.t.Branch('jphi_2_tr', self.jphi_2_tr, 'jphi_2_tr/D' )
        self.t.Branch('jcsv_2',    self.jcsv_2,    'jcsv_2/D' )
        self.t.Branch('jcsvfv_2', self.jcsvfv_2, 'jcsvfv_2/D' )

        self.t.Branch('bpt_1',     self.bpt_1,     'bpt_1/D' )
        self.t.Branch('bpt_1_tr',  self.bpt_1_tr,  'bpt_1_tr/D' )
        self.t.Branch('beta_1',    self.beta_1,    'beta_1/D' ) 
        self.t.Branch('beta_1_tr', self.beta_1_tr, 'beta_1_tr/D' )
        self.t.Branch('bphi_1',    self.bphi_1,    'bphi_1/D' )
        self.t.Branch('bphi_1_tr', self.bphi_1_tr, 'bphi_1_tr/D' )
        self.t.Branch('bcsv_1',    self.bcsv_1,    'bcsv_1/D' )
        self.t.Branch('bcsvfv_1', self.bcsvfv_1, 'bcsvfv_1/D' )
        self.t.Branch('bpt_2',     self.bpt_2,     'bpt_2[F' )
        self.t.Branch('bpt_2_tr',  self.bpt_2_tr,  'bpt_2_tr/D' )
        self.t.Branch('beta_2',    self.beta_2,    'beta_2/D' )
        self.t.Branch('beta_2_tr', self.beta_2_tr, 'beta_2_tr/D' )
        self.t.Branch('bphi_2',    self.bphi_2,    'bphi_2/D' )
        self.t.Branch('bphi_2_tr', self.bphi_2_tr, 'bphi_2_tr/D' )
        self.t.Branch('bcsv_2',    self.bcsv_2,    'bcsv_2/D' )
        self.t.Branch('bcsvfv_2', self.bcsvfv_2, 'bcsvfv_2/D' )
        '''
        if doSyst : 
                ...
                for i, v in enumerate(self.allsystMET):
                    ...
                    iiMET=iMET+'_noES'
                    self.t.Branch(iMET, self.list_of_arrays[i], '{0:s}/D'.format(iMET))
                    self.t.Branch(iiMET, self.list_of_arrays_noES[i], '{0:s}/D'.format(iiMET))

                for i, v in enumerate(self.allsystJets):
                    self.t.Branch('njets{0:s}'.format(v), self.list_of_arraysJetsNjets[i], 'njets{0:s}/D'.format(v))
                    self.t.Branch('nbtagL{0:s}'.format(v), self.list_of_arraysJetsNbtagL[i], 'nbtagL{0:s}/D'.format(v))
                    self.t.Branch('nbtagM{0:s}'.format(v), self.list_of_arraysJetsNbtagM[i], 'nbtagM{0:s}/D'.format(v))
                    self.t.Branch('nbtagT{0:s}'.format(v), self.list_of_arraysJetsNbtagT[i], 'nbtagT{0:s}/D'.format(v))
                    self.t.Branch('jflavour{0:s}'.format(v), self.list_of_arraysJetsFlavour[i], 'jflavour{0:s}[12]/D'.format(v))
                    self.t.Branch('jpt{0:s}'.format(v), self.list_of_arraysJetsPt[i], 'jpt{0:s}[12]/D'.format(v))
                    self.t.Branch('jeta{0:s}'.format(v), self.list_of_arraysJetsEta[i], 'jeta{0:s}[12]/D'.format(v))
                    self.t.Branch('btagDeep{0:s}'.format(v), self.list_of_arraysJetsNbtagDeep[i], 'btagDeep{0:s}[12]/D'.format(v))



        #self.MET_pt_jesEC2Up  = array('d',[0])
        #self.t.Branch('MET_pt_jesEC2Up', self.MET_pt_jesEC2Up, 'MET_pt_jesEC2Up/D' )
        self.tN=[]
